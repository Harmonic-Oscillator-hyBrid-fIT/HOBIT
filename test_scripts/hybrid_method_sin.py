...
# Generate synthetic data: y = 10 + 5*sin(3x + 2.5) + noise
n = 100
...
plt.savefig('images/original_data_sin.png', bbox_inches='tight')
plt.close()
print('Saved: images/original_data_sin.png')
...
start = time.time()
trig_reg.fit_sin(X_train, y_train, n_trials=500)
...
print('  a0=10.00, a1=5.00, omega=3.00, phi=2.50')
...
ax.legend(loc='best')
plt.savefig('images/Hybrid_sin.png', bbox_inches='tight')
plt.close()
print('Saved: images/Hybrid_sin.png')